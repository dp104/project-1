            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 shadow-2xl">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-4xl bg-[#0B0B0F] border border-white/10 rounded-2xl overflow-hidden flex flex-col md:flex-row shadow-[0_20px_60px_rgba(0,0,0,0.8)] z-10 max-h-[90vh]"
                    >
                        {/* Close Button */}
                        <button
                            onClick={onClose}
                        ...
                        {/* Image Section */}
                        <div className="w-full md:w-1/2 h-[350px] md:h-auto relative shrink-0">
                        ...
                        <div className="w-full md:w-1/2 p-6 md:p-10 flex flex-col overflow-y-auto">
                            <span className="text-[10px] text-cyan-400 font-sans tracking-widest uppercase mb-2">
                                {product.category}
                            </span>
