                ...
                >
                    ...
                    {product.label && (
                        <div className="absolute top-3 left-3 z-20">
                            <span className={`text-[10px] font-bold px-3 py-1.5 rounded-full shadow tracking-widest uppercase ${LABEL_STYLES[product.label] || 'bg-white/90 text-gray-800'}`}>
                                {product.label}
                            </span>
                        </div>
                    )}
                ...
                <div className="flex flex-col space-y-1.5 px-1">
                    <div className="flex justify-between items-start gap-2">
                        ...
                        <div className="shrink-0 text-right">
                            <p className="text-[19px] font-bold text-gray-900 font-sans leading-tight">
                                ₹{fmtPrice(product.price)}
                            </p>
                            {hasDiscount && (
                                <p className="text-[13px] text-gray-400 font-bold line-through leading-none mt-0.5">
                    ...
                    <div className="flex items-center gap-2 text-[10px] text-gray-500 uppercase tracking-widest font-sans font-bold mt-1">
